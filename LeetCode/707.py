...
class MyLinkedList:
    ...
    def addAtIndex(self, index, val):
        ...
        if index == 0:
            ...
            p = self.head
            if p is None:
                return 'AddAtIndex failed, target is not exist!'
            else:
                i = 0
                p = self.head
                while p.next is not None and i < index - 1:
                    i += 1
                    p = p.next
                if i == index - 1:
                    if p.next is None:
    ...
    def deleteAtIndex(self, index):
        ...
        """
        if self.head is None:
            print('DeleteAtIndex failed, MyLinkedList is empty.')
            return
        if index == 0:
            ...
            while p.next is not None and i < index - 1:
                ...
                p = p.next
            if p.next is None:
                return 'DeleteAtIndex failed, target is not exist!'
            else:
                p.next = p.next.next
